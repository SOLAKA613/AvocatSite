        <!--begin::Header-->
        <div id="kt_header" class="header align-items-stretch" style='BACKGROUND-COLOR: #e5e5ef;'>
            <!--begin::Container-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5">
                                    <a href="../../demo1/dist/apps/projects/list.html" class="menu-link px-5">
                                        <span class="menu-text">{{ __('messages.mes_dossiers')}}</span>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                    ...
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">{{__('messages.language')}}
                                            <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{__('messages.lang')}} 
                                                @switch($locale)
                                                    @case('ar')
                                                    <img class="w-15px h-15px rounded-1 ms-2" src="assets/media/flags/morocco.svg" alt="" />
                                                    @break
                                                    @case('fr')
                                                    <img class="w-15px h-15px rounded-1 ms-2" src="assets/media/flags/france.svg" alt="" />
                                                    @break
                                                    @default
                                                    <img src="{{asset('images/ar.jpg')}}" class="lng col-1">
                                                @endswitch      
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="lang/ar" class="menu-link d-flex px-5 active">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="assets/media/flags/morocco.svg" alt="" />
                                            </span>{{__('messages.arabe')}}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
